...
angular.module('demoBackend', ['ngMockE2E', 'smartRegisterApp'])
  .run ['$httpBackend', 'Config', 'authResponse', 'merchantsResponse', 'venuesResponse', 'posResponse', 'reportsResponse', 'ordersResponse', ($httpBackend, Config, authResponse, merchantsResponse, venuesResponse, posResponse, reportsResponse, ordersResponse) ->
